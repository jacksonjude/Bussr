...
class FilterButton: UIButton
{
    ...
    init(imagePath: String, superview: UIView)
    {
        ...
        super.init(frame: CGRect(x: superview.frame.width-imageSize-8, y: 0, width: imageSize, height: imageSize))
        ...
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: .top, relatedBy: .equal, toItem: self.superview, attribute: .top, multiplier: 1, constant: 0))
